...
public class RobotMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float h = Input.GetAxis(_horizontal);
        float v = Input.GetAxis(_vertical);
        //Get Raw input for rotation of robot player.
        float bodyRotationH = Input.GetAxisRaw(_horizontal);
        float bodyRotationV = Input.GetAxisRaw(_vertical);
